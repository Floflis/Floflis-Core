...
#"$(($currentupdate + 1))" #inspo from: /media/daniella/ceb6a175-7104-43d8-8064-48e6ef72cd27/flic/init-new-build.sh
...
if [ "$latestupdate" -gt "$currentupdate" ]
   then
      ...
      echo "Currently you have installed: Update $currentupdate ; But there's available: Update $latestupdate"
   else
